...
SECRET_KEY = 'django-insecure-!3n%465lqec!jjpn02d=ghp@g*-(%f489tn4-ra^(2zivvc@@b'
...
WSGI_APPLICATION = 'doexfoods.wsgi.application'
...
# Add this to configure JWT settings
SIMPLE_JWT = {
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'doncool933@gmail.com'
